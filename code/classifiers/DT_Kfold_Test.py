...
def dt_kfold(X, y, output_path, k_fold_cv, max_depth, method_name):
...
def dt_independent_test(X_train, y_train, X_test, y_test, output_path, max_depth, method_name):
...
dt_kfold(train_X, train_y, "kfold_result.xlsx", 5, max_depth, method_name)

dt_independent_test(train_X, train_y, test_X, test_y, "independent_test_result.xlsx" , max_depth, method_name)
